...
$(document).ready(function(){
    ...
    <div class="tools">
        ...
        <li ><a href="/Spring/admin.php/Admin/Info/city_add"><span><img src="/Spring/Public/admin/images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <tbody>
        <?php if(is_array($city)): $i = 0; $__LIST__ = $city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ci): $mod = ($i % 2 );++$i;?><tr class="click2">
            <input type="hidden"  value="<?php echo ($ci["ci_id"]); ?>" class="poid" />
        <td><?php echo ($ci["ci_id"]); ?></td>
        <td><a href="/Spring/admin.php/Admin/Info/city_add?ci_id=<?php echo ($ci["ci_id"]); ?>"><?php echo ($ci["ci_name"]); ?></a></td>
        <td><?php echo ($ci["ci_tea"]); ?></td>
        <td><a href="/Spring/admin.php/Admin/Info/city_Upde?id=<?php echo ($ci["ci_id"]); ?>" >修改</a>|<a href="/Spring/admin.php/Admin/Info/city_delete?id=<?php echo ($ci["ci_id"]); ?>" >删除</a></td>
