...
$(document).ready(function(e) {
    ...
    <ul class="forminfo">
    <li><label>年级名称</label>
		<input name="g_name"  type="text" class="dfinput" value="<?php echo ($gra["g_name"]); ?>" /><i>****级(注：只需填写年份)</i>
	</li>
        <input type="hidden" name="g_id" value="<?php echo ($gra["g_id"]); ?>" />
    <li><label>&nbsp;</label><?php if($gra["g_id"] == ''): ?><input name="sub" type="submit" class="btn" value="添 加"/><?php else: ?><input name="sub" type="submit" class="btn" value="修 改"/><?php endif; ?></li>
    </ul>
    </form>
