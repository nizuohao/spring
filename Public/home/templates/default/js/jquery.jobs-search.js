function allaround(templatedir,dir,jobslisturl,getkey,getarr)
{
	...
	var opthtm='';
	opthtm+='<div class="s1">';
	opthtm+='<div class="litit keysel">搜索：</div>';
	...
	opthtm+='</div>';
	opthtm+='</div>	';			
	opthtm+='<div class="keymore link_orange"><a href="'+href+'" id="advopen">高级搜索</a></div>';
	...
	opthtm+='<div class="litit csel">时间：</div>';
	opthtm+='<div class="littxt min">';
	opthtm+='<ul class="link_bk min">';	
	if (get[4]=='')
	{
	opthtm+='<li><a href="'+href+'" id="settr-3"  class="opt">一天内</a></li>';
	opthtm+='<li><a href="'+href+'" id="settr-7"  class="opt">一周内</a></li>';
	opthtm+='<li><a href="'+href+'" id="settr-15" class="opt">两周内</a></li>';
	opthtm+='<li><a href="'+href+'" id="settr-30" class="opt">一月内</a></li>';
	}
	else
	{
	...
	opthtm+='</div>';
	opthtm+='<div class="clear"></div>';
	opthtm+='<div class="litit csel">月薪：</div>';
	opthtm+='<div class="littxt min">';
	opthtm+='<ul class="link_bk min">';
	...
	opthtm+='</div>';
	opthtm+='<div class="clear"></div>';
	opthtm+='<div class="litit csel">规模：</div>';
	opthtm+='<div class="littxt min">';
	opthtm+='<ul class="link_bk min">';
