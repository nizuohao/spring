function allaround(templatedir,dir,jobslisturl,getkey,getarr)
{
	...
	opthtm+='<div class="subinputbox"><input type="submit" name="submit"  id="soall" value="搜全部" /></div>';
   ...
   search_location(jobslisturl)
	...
	{ 
		...
		$.post("__APP__/Job/stulist", {"act":jobslisturl,"key":key,"category":category,"subclass":subclass,"district":district,"sdistrict":sdistrict,"experience":experience,"education":education,"sex":sex,"photo":photo,"talent":talent,"inforow":inforow,"sort":sort_1,"page":page},
